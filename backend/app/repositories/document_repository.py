...
class DocumentRepository:
	...
	def create(
		...
		document = Document(filename=filename, pages_count=pages_count, status=status)
	...
	def update_result(self, document: Document, raw_text: str, structured_json: dict[str, Any]) -> Document:
